...
func (r *vstResponseElement) Endpoint() string {
	return ""
}
...
func (r *vstResponseElement) CheckStatus(validStatusCodes ...int) error {
...
func (r *vstResponseElement) ParseArrayBody() ([]driver.Response, error) {
